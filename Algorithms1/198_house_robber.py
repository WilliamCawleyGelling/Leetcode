...
class Solution:
    def rob(self, nums) :
        ...
        :rtype: int 
        """
        #one option is you could try all posible permutations 
        #the other is to have a running sum as you go along 
        #i could have two runnnig totals going side by side 
